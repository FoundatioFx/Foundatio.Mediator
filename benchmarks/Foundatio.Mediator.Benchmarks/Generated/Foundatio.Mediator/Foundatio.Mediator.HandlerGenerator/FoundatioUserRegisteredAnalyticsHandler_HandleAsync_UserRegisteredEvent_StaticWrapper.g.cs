...
{
    internal static class FoundatioUserRegisteredAnalyticsHandler_HandleAsync_UserRegisteredEvent_StaticWrapper
    {
        ...
        private static Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredAnalyticsHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredAnalyticsHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredAnalyticsHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredAnalyticsHandler>(serviceProvider);
                return _handler;
            }
        }
    }
