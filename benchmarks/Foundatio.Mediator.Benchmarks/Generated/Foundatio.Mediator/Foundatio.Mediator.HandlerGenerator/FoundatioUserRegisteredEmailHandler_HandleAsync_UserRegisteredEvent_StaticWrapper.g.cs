...
{
    internal static class FoundatioUserRegisteredEmailHandler_HandleAsync_UserRegisteredEvent_StaticWrapper
    {
        ...
        private static Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredEmailHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredEmailHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredEmailHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Benchmarks.Handlers.Foundatio.FoundatioUserRegisteredEmailHandler>(serviceProvider);
                return _handler;
            }
        }
    }
