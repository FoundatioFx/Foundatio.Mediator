...
- **Dead letters** supports payload/header inspection, single or batch retry, and confirmed flush with retained failed-job history. It inspects on entry or explicit refresh, never on the monitoring timer.
