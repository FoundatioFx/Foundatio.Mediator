...
{
    internal static class CreatePersonalizedGreetingHandler_HandleAsync_CreatePersonalizedGreetingQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(ConsoleSample.Messages.CreatePersonalizedGreetingQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                handlerResult = await handlerInstance.HandleAsync(message, serviceProvider.GetRequiredService<ConsoleSample.Services.IGreetingService>(), serviceProvider.GetRequiredService<Microsoft.Extensions.Logging.ILogger<ConsoleSample.Handlers.CreatePersonalizedGreetingHandler>>(), cancellationToken);
        ...
        {
            var typedMessage = (ConsoleSample.Messages.CreatePersonalizedGreetingQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "tT79g+aRQJPFlT6soNnraCkGAABTYW1wbGVSdW5uZXIuY3M=")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\samples\ConsoleSample\SampleRunner.cs(49,52)
        ...
        private static ConsoleSample.Handlers.CreatePersonalizedGreetingHandler? _handler;
        private static readonly object _lock = new object();

        private static ConsoleSample.Handlers.CreatePersonalizedGreetingHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<ConsoleSample.Handlers.CreatePersonalizedGreetingHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<ConsoleSample.Handlers.CreatePersonalizedGreetingHandler>(serviceProvider);
                return _handler;
            }
        }
