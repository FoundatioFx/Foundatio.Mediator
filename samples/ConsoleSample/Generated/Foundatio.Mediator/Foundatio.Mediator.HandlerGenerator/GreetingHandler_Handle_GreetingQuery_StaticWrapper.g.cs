...
{
    internal static class GreetingHandler_Handle_GreetingQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> Handle(ConsoleSample.Messages.GreetingQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (ConsoleSample.Messages.GreetingQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "tT79g+aRQJPFlT6soNnraDwEAABTYW1wbGVSdW5uZXIuY3M=")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\samples\ConsoleSample\SampleRunner.cs(37,40)
        ...
        private static ConsoleSample.Handlers.GreetingHandler? _handler;
        private static readonly object _lock = new object();

        private static ConsoleSample.Handlers.GreetingHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<ConsoleSample.Handlers.GreetingHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<ConsoleSample.Handlers.GreetingHandler>(serviceProvider);
                return _handler;
            }
        }
