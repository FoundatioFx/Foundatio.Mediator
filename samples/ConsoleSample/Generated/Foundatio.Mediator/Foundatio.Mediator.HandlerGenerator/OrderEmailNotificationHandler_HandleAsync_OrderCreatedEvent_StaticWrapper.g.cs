...
{
    internal static class OrderEmailNotificationHandler_HandleAsync_OrderCreatedEvent_StaticWrapper
    {
...
#pragma warning restore CS0219
        ...
        private static ConsoleSample.Handlers.OrderEmailNotificationHandler? _handler;
        private static readonly object _lock = new object();

        private static ConsoleSample.Handlers.OrderEmailNotificationHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<ConsoleSample.Handlers.OrderEmailNotificationHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<ConsoleSample.Handlers.OrderEmailNotificationHandler>(serviceProvider);
                return _handler;
            }
        }
