...
{
    internal static class PingHandler_HandleAsync_PingCommand_StaticWrapper
    {
        public static async System.Threading.Tasks.Task HandleAsync(ConsoleSample.Messages.PingCommand message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
...
#pragma warning restore CS0219
        ...
        {
            var typedMessage = (ConsoleSample.Messages.PingCommand)message;
            var serviceProvider = ((Mediator)mediator).ServiceProvider;
            await HandleAsync(typedMessage, serviceProvider, cancellationToken);
            return new object();
        }

        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "tT79g+aRQJPFlT6soNnraMgDAABTYW1wbGVSdW5uZXIuY3M=")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\samples\ConsoleSample\SampleRunner.cs(34,25)
        ...
        private static ConsoleSample.Handlers.PingHandler? _handler;
        private static readonly object _lock = new object();

        private static ConsoleSample.Handlers.PingHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<ConsoleSample.Handlers.PingHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<ConsoleSample.Handlers.PingHandler>(serviceProvider);
                return _handler;
            }
        }
