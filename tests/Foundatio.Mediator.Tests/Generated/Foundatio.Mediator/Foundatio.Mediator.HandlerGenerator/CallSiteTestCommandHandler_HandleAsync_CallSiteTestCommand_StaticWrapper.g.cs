...
{
    internal static class CallSiteTestCommandHandler_HandleAsync_CallSiteTestCommand_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.CallSiteTestCommand message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.CallSiteTestCommand)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "yaKerWo0gLu7Dq8X5JOjziQEAABDYWxsU2l0ZVZhbGlkYXRpb25UZXN0LmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\CallSiteValidationTest.cs(31,37)
        ...
        private static Foundatio.Mediator.Tests.CallSiteTestCommandHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.CallSiteTestCommandHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.CallSiteTestCommandHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.CallSiteTestCommandHandler>(serviceProvider);
                return _handler;
            }
        }
