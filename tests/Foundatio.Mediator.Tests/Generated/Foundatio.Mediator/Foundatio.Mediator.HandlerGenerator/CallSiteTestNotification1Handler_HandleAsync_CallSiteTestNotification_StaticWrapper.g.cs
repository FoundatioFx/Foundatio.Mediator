...
{
    internal static class CallSiteTestNotification1Handler_HandleAsync_CallSiteTestNotification_StaticWrapper
    {
        ...
        private static Foundatio.Mediator.Tests.CallSiteTestNotification1Handler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.CallSiteTestNotification1Handler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.CallSiteTestNotification1Handler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.CallSiteTestNotification1Handler>(serviceProvider);
                return _handler;
            }
        }
