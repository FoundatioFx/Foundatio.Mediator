...
{
    internal static class ComprehensiveCommandHandler_HandleAsync_ComprehensiveCommand_StaticWrapper
    {
        public static async System.Threading.Tasks.Task HandleAsync(Foundatio.Mediator.Tests.ComprehensiveCommand message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.ComprehensiveCommand)message;
            var serviceProvider = ((Mediator)mediator).ServiceProvider;
            await HandleAsync(typedMessage, serviceProvider, cancellationToken);
            return new object();
        }

        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "8vx6ML42qwG8QBnCWP4Sy78EAABIYW5kbGVyV3JhcHBlckNvbXByZWhlbnNpdmVUZXN0LmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\HandlerWrapperComprehensiveTest.cs(32,24)
        ...
        private static Foundatio.Mediator.Tests.ComprehensiveCommandHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.ComprehensiveCommandHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.ComprehensiveCommandHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.ComprehensiveCommandHandler>(serviceProvider);
                return _handler;
            }
        }
