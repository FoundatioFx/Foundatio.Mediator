...
{
    internal static class ComprehensiveStringQueryHandler_HandleAsync_ComprehensiveStringQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.ComprehensiveStringQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.ComprehensiveStringQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "8vx6ML42qwG8QBnCWP4SywoHAABIYW5kbGVyV3JhcHBlckNvbXByZWhlbnNpdmVUZXN0LmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\HandlerWrapperComprehensiveTest.cs(42,43)
        ...
        private static Foundatio.Mediator.Tests.ComprehensiveStringQueryHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.ComprehensiveStringQueryHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.ComprehensiveStringQueryHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.ComprehensiveStringQueryHandler>(serviceProvider);
                return _handler;
            }
        }
