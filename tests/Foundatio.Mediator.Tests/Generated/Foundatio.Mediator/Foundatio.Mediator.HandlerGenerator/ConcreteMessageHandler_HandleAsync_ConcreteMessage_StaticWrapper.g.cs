...
{
    internal static class ConcreteMessageHandler_HandleAsync_ConcreteMessage_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.ConcreteMessage message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
