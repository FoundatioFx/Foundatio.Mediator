...
{
    internal static class FixedAsync1Handler_HandleAsync_FixedAsyncNotification_StaticWrapper
    {
        ...
        private static Foundatio.Mediator.Tests.FixedAsync1Handler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.FixedAsync1Handler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.FixedAsync1Handler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.FixedAsync1Handler>(serviceProvider);
                return _handler;
            }
        }
