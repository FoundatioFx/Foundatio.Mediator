...
{
    internal static class FixedSyncCommand1Handler_Handle_FixedSyncCommand_StaticWrapper
    {
        ...
        private static Foundatio.Mediator.Tests.FixedSyncCommand1Handler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.FixedSyncCommand1Handler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.FixedSyncCommand1Handler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.FixedSyncCommand1Handler>(serviceProvider);
                return _handler;
            }
        }
