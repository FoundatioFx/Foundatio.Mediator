...
{
    internal static class InterfaceTestMessageHandler_HandleAsync_InterfaceTestMessage_StaticWrapper
    {
        public static async System.Threading.Tasks.Task HandleAsync(Foundatio.Mediator.Tests.InterfaceTestMessage message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.InterfaceTestMessage)message;
            var serviceProvider = ((Mediator)mediator).ServiceProvider;
            await HandleAsync(typedMessage, serviceProvider, cancellationToken);
            return new object();
        }

        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "Di3y+hp75nkUo+98072rs/YFAABIYW5kbGVySW50ZXJmYWNlVGVzdC5jcw==")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\HandlerInterfaceTest.cs(41,24)
        ...
        private static Foundatio.Mediator.Tests.InterfaceTestMessageHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.InterfaceTestMessageHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.InterfaceTestMessageHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.InterfaceTestMessageHandler>(serviceProvider);
                return _handler;
            }
        }
