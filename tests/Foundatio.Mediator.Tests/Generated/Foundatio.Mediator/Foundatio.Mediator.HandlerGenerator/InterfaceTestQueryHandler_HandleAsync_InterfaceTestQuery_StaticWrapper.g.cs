...
{
    internal static class InterfaceTestQueryHandler_HandleAsync_InterfaceTestQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.InterfaceTestQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.InterfaceTestQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "Di3y+hp75nkUo+98072rs/gLAABIYW5kbGVySW50ZXJmYWNlVGVzdC5jcw==")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\HandlerInterfaceTest.cs(76,37)
        ...
        private static Foundatio.Mediator.Tests.InterfaceTestQueryHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.InterfaceTestQueryHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.InterfaceTestQueryHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.InterfaceTestQueryHandler>(serviceProvider);
                return _handler;
            }
        }
