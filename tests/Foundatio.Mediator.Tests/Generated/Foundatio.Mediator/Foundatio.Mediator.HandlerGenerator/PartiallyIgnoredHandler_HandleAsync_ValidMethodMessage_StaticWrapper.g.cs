...
{
    internal static class PartiallyIgnoredHandler_HandleAsync_ValidMethodMessage_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.ValidMethodMessage message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.ValidMethodMessage)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "Nk8Oj855nEH0XEDBm64GOgQDAABGb3VuZGF0aW9JZ25vcmVBdHRyaWJ1dGVUZXN0LmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\FoundatioIgnoreAttributeTest.cs(23,37)
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "qBqA1uc5D4EDHqEiTWhUmycGAABGb3VuZGF0aW9JZ25vcmVDb21waWxlVGltZUVycm9yVGVzdC5jcw==")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\FoundatioIgnoreCompileTimeErrorTest.cs(38,32)
        ...
        private static Foundatio.Mediator.Tests.PartiallyIgnoredHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.PartiallyIgnoredHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.PartiallyIgnoredHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.PartiallyIgnoredHandler>(serviceProvider);
                return _handler;
            }
        }
