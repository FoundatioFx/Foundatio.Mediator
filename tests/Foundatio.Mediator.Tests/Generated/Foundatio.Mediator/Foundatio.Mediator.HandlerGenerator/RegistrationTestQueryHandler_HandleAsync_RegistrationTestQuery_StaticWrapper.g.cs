...
{
    internal static class RegistrationTestQueryHandler_HandleAsync_RegistrationTestQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.RegistrationTestQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.RegistrationTestQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "H4MTnuKAVyxV6/sezoW2yXENAABTZXJ2aWNlUmVnaXN0cmF0aW9uVGVzdC5jcw==")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\ServiceRegistrationTest.cs(72,37)
        ...
        private static Foundatio.Mediator.Tests.RegistrationTestQueryHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.RegistrationTestQueryHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.RegistrationTestQueryHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.RegistrationTestQueryHandler>(serviceProvider);
                return _handler;
            }
        }
