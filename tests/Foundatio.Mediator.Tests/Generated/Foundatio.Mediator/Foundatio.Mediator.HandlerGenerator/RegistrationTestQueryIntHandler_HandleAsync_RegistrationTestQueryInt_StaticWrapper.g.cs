...
{
    internal static class RegistrationTestQueryIntHandler_HandleAsync_RegistrationTestQueryInt_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<int> HandleAsync(Foundatio.Mediator.Tests.RegistrationTestQueryInt message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.RegistrationTestQueryInt)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "H4MTnuKAVyxV6/sezoW2yfQOAABTZXJ2aWNlUmVnaXN0cmF0aW9uVGVzdC5jcw==")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\ServiceRegistrationTest.cs(79,40)
        ...
        private static Foundatio.Mediator.Tests.RegistrationTestQueryIntHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.RegistrationTestQueryIntHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.RegistrationTestQueryIntHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.RegistrationTestQueryIntHandler>(serviceProvider);
                return _handler;
            }
        }
