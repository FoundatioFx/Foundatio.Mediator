...
{
    internal static class TestMessageForMassTransitExclusionHandler_HandleAsync_TestMessageForMassTransitExclusion_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.TestMessageForMassTransitExclusion message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.TestMessageForMassTransitExclusion)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "6E5m6KLYCidFmuFIDmGwWToDAABNYXNzVHJhbnNpdEV4Y2x1c2lvblRlc3QuY3M=")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\MassTransitExclusionTest.cs(25,41)
        ...
        private static Foundatio.Mediator.Tests.TestMessageForMassTransitExclusionHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.TestMessageForMassTransitExclusionHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.TestMessageForMassTransitExclusionHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.TestMessageForMassTransitExclusionHandler>(serviceProvider);
                return _handler;
            }
        }
