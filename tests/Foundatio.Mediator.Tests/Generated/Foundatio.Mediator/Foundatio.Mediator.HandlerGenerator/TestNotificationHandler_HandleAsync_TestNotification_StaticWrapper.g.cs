...
{
    internal static class TestNotificationHandler_HandleAsync_TestNotification_StaticWrapper
    {
        public static async System.Threading.Tasks.Task HandleAsync(Foundatio.Mediator.Tests.TestNotification message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.TestNotification)message;
            var serviceProvider = ((Mediator)mediator).ServiceProvider;
            await HandleAsync(typedMessage, serviceProvider, cancellationToken);
            return new object();
        }

        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "TQ8/MFFjMs/yrzkPIax2uh4FAABNZWRpYXRvclRlc3RzLmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\MediatorTests.cs(47,25)
        ...
        private static Foundatio.Mediator.Tests.TestNotificationHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.TestNotificationHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.TestNotificationHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.TestNotificationHandler>(serviceProvider);
                return _handler;
            }
        }
