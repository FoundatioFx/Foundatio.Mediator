...
{
    internal static class TestQueryHandler_HandleAsync_TestQuery_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.TestQuery message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.TestQuery)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "TQ8/MFFjMs/yrzkPIax2utoDAABNZWRpYXRvclRlc3RzLmNz")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\MediatorTests.cs(36,38)
        ...
        private static Foundatio.Mediator.Tests.TestQueryHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.TestQueryHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.TestQueryHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.TestQueryHandler>(serviceProvider);
                return _handler;
            }
        }
