...
{
    internal static class TestQueryWithDependenciesHandler_HandleAsync_TestQueryWithDependencies_StaticWrapper
    {
        public static async System.Threading.Tasks.Task<string> HandleAsync(Foundatio.Mediator.Tests.TestQueryWithDependencies message, IServiceProvider serviceProvider, CancellationToken cancellationToken)
        {
            var handlerInstance = GetOrCreateHandler(serviceProvider);
            return await handlerInstance.HandleAsync(message, serviceProvider.GetRequiredService<Foundatio.Mediator.Tests.ITestService>(), cancellationToken);
        }
        ...
        {
            var typedMessage = (Foundatio.Mediator.Tests.TestQueryWithDependencies)message;
        ...
        [global::System.Runtime.CompilerServices.InterceptsLocation(1, "fu4id1aiSBQYcG2xaNqrpwIGAABEZXBlbmRlbmN5SW5qZWN0aW9uVGVzdHMuY3M=")] // C:\Users\eric\Projects\Foundatio\Foundatio.Mediator\tests\Foundatio.Mediator.Tests\DependencyInjectionTests.cs(48,38)
        ...
        private static Foundatio.Mediator.Tests.TestQueryWithDependenciesHandler? _handler;
        private static readonly object _lock = new object();

        private static Foundatio.Mediator.Tests.TestQueryWithDependenciesHandler GetOrCreateHandler(IServiceProvider serviceProvider)
        {
            if (_handler != null)
                return _handler;

            var handlerFromDI = serviceProvider.GetService<Foundatio.Mediator.Tests.TestQueryWithDependenciesHandler>();
            ...
            lock (_lock)
            {
                ...
                _handler = ActivatorUtilities.CreateInstance<Foundatio.Mediator.Tests.TestQueryWithDependenciesHandler>(serviceProvider);
                return _handler;
            }
        }
